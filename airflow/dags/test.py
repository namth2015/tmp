...
with DAG(
    ...
    query_task = TrinoOperator(
        ...
        sql="insert into hive.test.nganhangso select * from sqlserver.dbo.nganhangso where date_format(d_date_time, '%Y%m%d') = '20240627'",  # Replace with your Trino SQL query
